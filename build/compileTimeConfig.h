...
#define HAVE_ZIP_FLAGS_T 0
#define HAVE_ZIP_SOURCE_T 0
#define HAVE_ZIP_FL_ENC_GUESS 0
#define HAVE_ZIP_H 1
#define KIVM_THREADED 1
#define KIVM_ARCH_x86 0
#define KIVM_ARCH_x86_64 0
#define KIVM_ARCH_arm 1
#define KIVM_ARCH_aarch64 0

#define KIVM_ARCH_NAME L"arm"
